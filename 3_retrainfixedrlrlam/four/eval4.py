...
if __name__ == "__main__":
    m_dir = '/home/yuchaohui/fcl/3_retrainfixedrlrlam/four/'
    V = scipy.sparse.load_npz(m_dir+'VW_100000_4/V_spr_15_0001_0002.npz')
    W = scipy.sparse.load_npz(m_dir+'VW_100000_4/W_spr_15_0001_0002.npz')
