...
if __name__ == "__main__":
    m_dir = '/home/yuchaohui/fcl/3_retrainfixedrlrlam/noRegu/'
    V = scipy.sparse.load_npz(m_dir+'VW_100000/V_spr_15_0002_0.001.npz')
    W = scipy.sparse.load_npz(m_dir+'VW_100000/W_spr_15_0002_0.001.npz')
    print(type(V))
    ...
    with open("resnoRelu.txt",'wb') as f:
