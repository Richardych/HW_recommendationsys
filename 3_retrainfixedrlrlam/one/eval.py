...
if __name__ == "__main__":
    m_dir = '/home/yuchaohui/fcl/3_retrainfixedrlrlam/one/'
    V = scipy.sparse.load_npz(m_dir+'VW_100000_1/V_spr_15_0001_0002.npz')
    W = scipy.sparse.load_npz(m_dir+'VW_100000_1/W_spr_15_0001_0002.npz')
